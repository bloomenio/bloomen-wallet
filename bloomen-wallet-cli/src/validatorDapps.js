...
var x = [objectDapp1, objectDapp2, objectDapp3, objectDapp4, objectDapp5, objectDapp6, objectDapp7, objectDapp8,
...
var validateSuperRules = function (validator) {
    return validator
        ...
        .If(function (field) { return field.dappId != null && field.laf.theme != null; }, function (firstValidation) { return firstValidation
        ...
        .ToResult(); })
        .If(function (field) { return field.news != null && field.news.length > 0; }, function (validatorIden) { return validatorIden
...
var validateNewsFields = function (validator) {
    ...
    }, function (secondValidator) { return secondValidator
